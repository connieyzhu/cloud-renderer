    ...
    load( gl ) {
        ...
        if (material.hasTexture()) {
            ...
            for (let i = 0; i < vertex_positions.length / 3; i++) {
                vertex_data.push(
                    vertex_positions[i * 3], vertex_positions[i * 3 + 1], vertex_positions[i * 3 + 2],
                    vertex_normals[i * 3], vertex_normals[i * 3 + 1], vertex_normals[i * 3 + 2],
                    vertex_tangents[i * 3], vertex_tangents[i * 3 + 1], vertex_tangents[i * 3 + 2],
                    vertex_texture_coords[i * 2], vertex_texture_coords[i * 2 + 1]
                )
            }
        } else {
            for (let i = 0; i < vertex_positions.length / 3; i++) {
